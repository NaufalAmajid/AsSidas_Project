...
<head>
    ...
    <link rel="icon" href="{{ asset('template/images/logo.png') }}" type="image/ico" />

    <title>Dashboard Admin | Yayasan Murah Hati </title>
    ...
    <link href="{{ asset('adminTemplate/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css') }}"
        rel="stylesheet">
    <!-- JQVMap -->
        ...
        <div class="main_container">
                ...
                <div class="left_col scroll-view">
                    ...
                    <div class="profile clearfix">
                        <div class="profile_pic">
                            <img src="{{ asset('adminTemplate/production/images/img.jpg') }}" alt="..."
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a href="{{ route('adminArtikel.index') }}"><i class="fa fa-edit"></i> Artikel </a></li>
                                <li><a href="{{ route('adminGallery.index') }}"><i class="fa fa-image"></i> Gallery </a></li>
                            </ul>
                        </div>
                        ...
                        <ul class=" navbar-right">
                            <li class="nav-item dropdown open" style="padding-left: 15px;">
                                <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true"
                                    ...
                                    <img src="{{ asset('template/images/logo.png') }}" alt="">Admin
                                </a>
            ...
            <footer>
                <div class="pull-right">
                    Dashboard Admin | Yayasan Murah Hati by <a href="#">Daqu Dev.</a>
                </div>
                <div class="clearfix"></div>
            </footer>
            <!-- /footer content -->
